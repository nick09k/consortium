                ...
                <div class="g-margin-t-30--xs g-margin-t-0--sm g-margin-b-30--xs g-margin-b-70--md g-margin-l-20--xs g-margin-l-80--sm">
                    ...
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s">
                                <a href="#register" title="Register">
                                    ...
                                    <span class="text-uppercase s-btn--primary-bg g-radius--50 g-padding-x-30--xs g-padding-y-15--xs g-font-size-13--xs g-color--white g-padding-x-15--xs">Register Now <span class="ti-angle-down"></span></span>
                                </a>
                            </div>
