...
<html lang="en" class="no-js">
  <?php $pagetitle = 'Zero To One | Consortium'; ?>
  ...
  <!-- End Head -->
    ...
    <body>
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 event-landing1" style="background: url('img/1920x1080/zerotoone.jpg'); height: 140vh" id="swades">
          <style type="text/css">
            ...
            <div class="container g-ver-center--sm g-padding-y-125--xs g-padding-y-0--lg event-landing-inner brain">
                    ...
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s" style="text-align:center;background: #a43739ab;padding: 30px 35px;">


                        <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white" style="font-weight:900">Zero <b>To</b> One</h2>
                        <a href="https://goo.gl/forms/vn1Bbq86YjfvCWAf2" title="Register" style="text-align:center;">
